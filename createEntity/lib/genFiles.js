...
const genFiles = (entityName) => {
    ...
    const modelStream = fs.createWriteStream(`${__dirname}/../../models/${capitalize(entityName)}.js`);
    ...
    modelStream.once('open', () => genModel(modelStream, capitalize(entityName)))
    controllerStream.once('open', () => genControllers(controllerStream, entityName, capitalize(entityName)));
    routeStream.once('open', () => genRoutes(routeStream, entityName, capitalize(entityName)))
}
